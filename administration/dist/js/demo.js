...
(function ($) {
  ...
  $container.append(
    '<h5>Personnalisation</h5><hr class="mb-2"/>'
  )
  ...
  $container.append('<h6>Options de l\'entête</h6>')
  ...
  $container.append('<h6>Option de barre de navigation</h6>')
  ...
  $container.append('<h6>Options du pieds de page</h6>')
